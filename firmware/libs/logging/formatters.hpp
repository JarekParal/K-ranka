...
template < >
struct FmtStr< int16_t > { FMT_CONST( "d" ); };

template < >
struct FmtStr< int32_t > { FMT_CONST( "d" ); };

template < >
struct FmtStr< int64_t > { FMT_CONST( "d" ); };

template < >
struct FmtStr< uint8_t > { FMT_CONST( "c" ); };

template < >
struct FmtStr< uint16_t > { FMT_CONST( "u" ); };

template < >
struct FmtStr< uint32_t > { FMT_CONST( "u" ); };

template < >
struct FmtStr< uint64_t > { FMT_CONST( "u" ); };
